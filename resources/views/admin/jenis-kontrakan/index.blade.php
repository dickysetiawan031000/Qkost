...
<div class="table-responsive col-lg-10">
    ...
    <a href="{{ route('admin.jenis-kontrakan.create') }}" class="btn btn-primary mb-3"> Create New Jenis</a>
    <table class="table table-striped table-sm">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $jenis->harga }}</td>
                <td>
                    <a href="{{ route('admin.jenis-kontrakan.edit', $jenis->id) }}" class="badge bg-warning"><i
