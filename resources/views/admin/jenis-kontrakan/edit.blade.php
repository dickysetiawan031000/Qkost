...
<main class="content">
    ...
    <section class="p-3">
        ...
        <div class="information d-flex flex-column gap-3">
            ...
            <form action="{{ route('admin.jenis-kontrakan.update', $jenisKontrakan->id) }}" method="post"
                class="col-lg-8">
                @csrf
                @method('put')
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                        name="alamat" value="{{ old('alamat', $jenisKontrakan->alamat) }}">
                </div>
                @error('alamat')
                <div class="invalid-feedback">
                    {{ $message }}
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control @error('harga') is-invalid @enderror" id="harga"
                        name="harga" value="{{ old('harga', $jenisKontrakan->harga) }}">
                </div>
                @error('harga')
                <div class="invalid-feedback">
                    {{ $message }}
